...
export default function MarksPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
      <UnifiedHeader title="Marks" />

      <main className="flex-1 container max-w-md mx-auto p-4">
        <div className="space-y-6 pb-16">
          <div>
            <h1 className="text-2xl font-bold">Marks Management</h1>
            <p className="text-muted-foreground mt-1">Enter and view student marks</p>
          </div>

          <Tabs value={activeTab} onValueChange={setActiveTab}>
            <TabsList className="grid w-full grid-cols-2 mb-4">
              <TabsTrigger value="enter">Enter Marks</TabsTrigger>
              <TabsTrigger value="statistics">Class Statistics</TabsTrigger>
            </TabsList>
